...
class BPMN():
    ...
    def bpmn_process(self, is_show_lane, is_show_gateway):
        ...
        self.indent(header_bpmn)
        tree.write("result_bpmn_process_from_nlp.xml", encoding="utf-8", xml_declaration=True)
        tree.write("result_bpmn_process_from_nlp.bpmn", encoding="utf-8", xml_declaration=True)